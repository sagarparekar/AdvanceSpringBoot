...
public class IteamDTO {
    ...
    private BchDtlsDTO bchDtlsDTO;

    private List<AttributeDetailsDTO> attribDtls;
    ...
    public BchDtlsDTO getBchDtls() {
        return bchDtlsDTO;
    }

    public void setBchDtls(BchDtlsDTO bchDtlsDTO) {
        this.bchDtlsDTO = bchDtlsDTO;
    }

    public List<AttributeDetailsDTO> getAttribDtls() {
        return attribDtls;
    }

    public void setAttribDtls(List<AttributeDetailsDTO> attribDtls) {
